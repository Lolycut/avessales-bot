...
GROUPHELP_TEXT = (
    ...
    "1️⃣ <b>Добавьте бота в беседу</b> вашей группы\n"
    "2️⃣ <b>Сделайте бота администратором чата</b> (это необходимо, чтобы телеграмм разрешил боту читать сообщения с вопросами без обязательного тега через @bot)\n"
    "3️⃣ <b>Привяжите академическую группу:</b>\n"
    "• Отправьте команду <code>/chat_settings</code>\n"
    "• Нажмите <b>«🎓 Установить группу беседы»</b> и выберите курс и номер группы (например, <i>2-41</i>)\n\n"
    "⚡ <b>Как общаться с ботом в беседе:</b>\n"
    "Чтобы не мешать живому общению во флуде, бот реагирует только на сообщения со словом <b>«Бот»</b> в начале:\n"
    "• <b>«Бот»</b> — быстрая проверка онлайна (ответит <i>«Летаю! 🦅»</i>)\n"
    "• <b>«Бот что завтра?»</b>, <b>«Бот расписание на неделю»</b>\n"
    "• <b>«Бот ко 2 паре во вт»</b>, <b>«Бот что 3 парой?»</b>\n"
    "• <b>«Бот отработка англ»</b>, <b>«Бот где беляз?»</b>\n"
    "• <b>«Бот где Гричик?»</b>, <b>«Бот свободные поточки сейчас»</b>\n\n"
    "🔔 <b>Автоматические функции беседы:</b>\n"
